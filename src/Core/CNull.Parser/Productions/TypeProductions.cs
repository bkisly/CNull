...
namespace CNull.Parser.Productions
{
    ...
    /// </summary>
    public interface IDeclarableType
    {
        /// <summary>
    ...
    public record PrimitiveType(PrimitiveTypes TypeSpecifier) : ReturnType, IDeclarableType
    {
    ...
    public record DictionaryType(PrimitiveType KeyType, PrimitiveType ValueType) : ReturnType, IDeclarableType
    {
